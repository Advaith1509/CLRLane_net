...
class TrainLaneNet(): 
    def __init__(self, cfg):
        self.cfg = cfg
        self.model = LaneNet().cuda()
        self.optimizer = torch.optim.Adam(self.model.parameters(), lr=self.cfg.lanenet_lr)
        self.scheduler = build_scheduler(self.cfg, self.optimizer)
        self.bce_loss = nn.BCELoss()
        self.batch_size = self.cfg.lanenet_batch_size # number of lanes per batch
