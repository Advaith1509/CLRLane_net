...
class GeneratePairs(nn.Module):
    def __init__(self, cfg):
        ...
        self.neg_dist_thresh = self.cfg.lanenet_neg_dist_thresh #0.9
        self.pos_dist_thresh = self.cfg.lanenet_pos_dist_thresh # 0.3
        self.batch_size = self.cfg.lanenet_batch_size
